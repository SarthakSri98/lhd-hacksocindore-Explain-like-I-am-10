...
i;
  ...
  width= '600px';
  height1 = '600px';
  constructor(private modalService: MatDialog , private _topicService : TopicServiceService) { }
  ...
  getTopics()
  {
    this._topicService.getTopics().subscribe(res=>{
...
// Reactive form formGroup data  
  ...
  add()
  {
    this._topicService.postTopic(this.addForm.value).subscribe(data=>{
